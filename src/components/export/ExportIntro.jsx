    ...
    <div className="container-x grid gap-16 lg:grid-cols-12">
      ...
      <div className="lg:col-span-8">
        <div className="border-l border-primary/40 pl-8">
          ...
          <p className="mt-8 font-display text-3xl leading-snug text-cocoa md:text-4xl">Our export practice is built around repeat buyers — importers, distributors, retailers, and custom-packaging brands planning multiple shipments per year.</p>
