...
export const AboutPullQuote = () => (
  <section className="section-screen bg-cocoa text-paper">
    <div className="absolute inset-0 opacity-20">
      <img src={farmerField} alt="" className="h-full w-full object-cover" />
    </div>
    <div className="container-x relative z-10 text-center">
      ...
      <p className="mx-auto mt-10 max-w-4xl font-display text-3xl leading-snug text-paper md:text-5xl">
        "We move Indian spice from anonymous sacks to named, documented, design-led packs — without losing the soul of the field."
      </p>
