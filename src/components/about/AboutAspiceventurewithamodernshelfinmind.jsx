...
export const AboutAspiceventurewithamodernshelfinmind = () => (
    ...
    <section className="section-screen bg-background">
      <div className="container-x grid items-center gap-12 lg:grid-cols-12">
        <div className="lg:col-span-7 order-1 lg:order-1">
          <div className="relative">
            <div className="absolute -left-6 -top-6 hidden h-32 w-32 border border-primary/40 lg:block" />
              <img src={spiceMarket} alt="A spice venture with a modern shelf in mind." className="relative h-[64vh] w-full object-cover shadow-deep" />
          </div>
        </div>
        <div className="lg:col-span-5 order-2 lg:order-2">
          ...
          <h2 className="display-md mt-8 text-cocoa">A spice venture with a modern shelf in mind.</h2>
