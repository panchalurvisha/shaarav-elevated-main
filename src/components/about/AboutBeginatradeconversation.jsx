...
export const AboutBeginatradeconversation = () => (
      ...
      <div className="container-x grid items-center gap-12 lg:grid-cols-12">
        <div className="lg:col-span-7 lg:order-2">
          <div className="relative">
            <div className="absolute -right-6 -top-6 hidden h-32 w-32 border border-primary/40 lg:block" />
              <img src={heroSpices} alt="Begin a trade conversation." className="relative h-[64vh] w-full object-cover shadow-deep" />
          </div>
        </div>
        <div className="lg:col-span-5 lg:order-1">
          <div className="flex items-center gap-4">
            ...
            <span className="text-xs uppercase tracking-[0.3em] text-cocoa/55">Next</span>
          </div>
          <h2 className="display-md mt-8 text-cocoa">Begin a trade conversation.</h2>
          <p className="mt-6 text-lg leading-relaxed text-cocoa/75">Explore our catalogue or share a requirement — we will respond with feasibility, samples, and timing.</p>
