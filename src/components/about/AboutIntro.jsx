    ...
    <div className="container-x grid gap-16 lg:grid-cols-12">
      ...
      <div className="lg:col-span-8">
        <div className="border-l border-primary/40 pl-8">
          ...
          <p className="mt-8 font-display text-3xl leading-snug text-cocoa md:text-4xl">We treat spices the way fine houses treat tea, coffee, and olive oil — with origin clarity, batch honesty, and packaging that respects the product inside.</p>
