...
export const AboutProcurementqualitypackinglogisticsoneteam = () => (
      ...
      <div className="container-x grid items-center gap-12 lg:grid-cols-12">
        <div className="lg:col-span-7 lg:order-2">
          <div className="relative">
            <div className="absolute -right-6 -top-6 hidden h-32 w-32 border border-primary/40 lg:block" />
              <img src={qualityLab} alt="Procurement, quality, packing, logistics — one team." className="relative h-[64vh] w-full object-cover shadow-deep" />
          </div>
        </div>
        <div className="lg:col-span-5 lg:order-1">
          <div className="flex items-center gap-4">
            ...
            <span className="text-xs uppercase tracking-[0.3em] text-cocoa/55">People</span>
          </div>
          <h2 className="display-md mt-8 text-cocoa">Procurement, quality, packing, logistics — one team.</h2>
          <p className="mt-6 text-lg leading-relaxed text-cocoa/75">A short, accountable supply chain protects flavour, colour, and freshness from field to carton.</p>
