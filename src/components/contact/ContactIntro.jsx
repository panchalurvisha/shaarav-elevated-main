    ...
    <div className="container-x grid gap-16 lg:grid-cols-12">
      <div className="lg:col-span-4">
        ...
        <div className="mt-10 border-t border-border">
          {[{ "label": "Email", "value": "info@shaaravglobalexim.com" }, { "label": "Phone", "value": "+91 90236 71539" }, { "label": "Office", "value": "Ahmedabad, India" }, { "label": "Response", "value": "Within 24h (Mon–Sat)" }].map((m) => (
      ...
      <div className="lg:col-span-8">
        <div className="border-l border-primary/40 pl-8">
          ...
          <p className="mt-8 font-display text-3xl leading-snug text-cocoa md:text-4xl">We respond to qualified import, distribution, retail, and bulk-packaging inquiries with feasibility, sample plan, and quote.</p>
