  ...
  <section className="section-screen bg-paper">
    <div className="container-x grid gap-16 lg:grid-cols-12">
      <div className="lg:col-span-4">
        <span className="eyebrow">Our Stance</span>
        ...
        <div className="mt-10 border-t border-border">
          {[{"label":"Sourcing","value":"Farm-linked"},{"label":"Waste","value":"Reduced by design"},{"label":"Packaging","value":"Buyer-aligned materials"},{"label":"Logistics","value":"Consolidated lanes"}].map((m) => (
      ...
      <div className="lg:col-span-8">
        <div className="border-l border-primary/40 pl-8">
          ...
          <p className="mt-8 font-display text-3xl leading-snug text-cocoa md:text-4xl">Sustainability at Shaarav is structural — embedded in how we source, clean, pack, and ship — not a marketing layer.</p>
          <div className="mt-10 flex items-center gap-4 text-xs uppercase tracking-[0.3em] text-cocoa/55">
            <span className="h-px w-10 bg-primary" />
            <span>Shaarav Editorial · Sustainability</span>
          </div>
        </div>
      </div>
    </div>
