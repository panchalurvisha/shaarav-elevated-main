...
export const SustainabilityHonestpackaging = () => (
        ...
        <div className="grid items-end gap-10 border-b border-border pb-10 lg:grid-cols-12">
          <div className="lg:col-span-7">
            <div className="flex items-center gap-4">
              ...
              <span className="text-xs uppercase tracking-[0.3em] text-cocoa/55">Material</span>
            </div>
            <h2 className="display-md mt-6 max-w-3xl text-cocoa">Honest packaging.</h2>
          </div>
          <p className="text-lg leading-relaxed text-cocoa/70 lg:col-span-5">We help buyers choose materials that protect the spice and respect the shelf — without overengineering.</p>
        </div>
