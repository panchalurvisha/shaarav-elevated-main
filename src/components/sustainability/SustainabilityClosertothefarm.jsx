...
export const SustainabilityClosertothefarm = () => (
      ...
      <div className="container-x grid items-center gap-12 lg:grid-cols-12">
        <div className="lg:col-span-7 order-1 lg:order-1">
          <div className="relative">
            <div className="absolute -left-6 -top-6 hidden h-32 w-32 border border-primary/40 lg:block" />
              <img src={farmerField} alt="Closer to the farm." className="relative h-[64vh] w-full object-cover shadow-deep" />
          </div>
        </div>
        <div className="lg:col-span-5 order-2 lg:order-2">
          <div className="flex items-center gap-4">
            ...
            <span className="text-xs uppercase tracking-[0.3em] text-cocoa/55">Field</span>
          </div>
          <h2 className="display-md mt-8 text-cocoa">Closer to the farm.</h2>
          <p className="mt-6 text-lg leading-relaxed text-cocoa/75">Direct and semi-direct relationships protect freshness and create visibility into how spices are grown and handled.</p>
