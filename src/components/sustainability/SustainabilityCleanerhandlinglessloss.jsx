...
export const SustainabilityCleanerhandlinglessloss = () => (
        ...
        <div className="grid items-end gap-10 border-b border-border pb-10 lg:grid-cols-12">
          <div className="lg:col-span-7">
            <div className="flex items-center gap-4">
              ...
              <span className="text-xs uppercase tracking-[0.3em] text-cocoa/55">Process</span>
            </div>
            <h2 className="display-md mt-6 max-w-3xl text-cocoa">Cleaner handling, less loss.</h2>
          </div>
          <p className="text-lg leading-relaxed text-cocoa/70 lg:col-span-5">Sorting, grading, and pack planning reduce avoidable rejection and waste across the line.</p>
        </div>
