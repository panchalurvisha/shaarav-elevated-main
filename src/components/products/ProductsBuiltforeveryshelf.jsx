...
export const ProductsBuiltforeveryshelf = () => (
        ...
        <div className="grid items-end gap-10 border-b border-border pb-10 lg:grid-cols-12">
          <div className="lg:col-span-7">
            <div className="flex items-center gap-4">
              ...
              <span className="text-xs uppercase tracking-[0.3em] text-cocoa/55">Pack formats</span>
            </div>
            <h2 className="display-md mt-6 max-w-3xl text-cocoa">Built for every shelf.</h2>
          </div>
          <p className="text-lg leading-relaxed text-cocoa/70 lg:col-span-5">Soft-touch pouches, heritage cartons, apothecary jars, bulk kraft, and full export cartons.</p>
        </div>
