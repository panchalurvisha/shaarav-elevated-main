    ...
    <section className="section-screen bg-surface">
      <div className="container-x grid items-center gap-12 lg:grid-cols-12">
          ...
          <div className="relative">
            <div className="absolute -right-6 -top-6 hidden h-32 w-32 border border-primary/40 lg:block" />
              <Link to="/products/garam-masala" className="block overflow-hidden relative shadow-deep group">
                <img src={productGaram} alt="SHAARAV Garam Masala" className="h-[64vh] w-full object-cover transition-transform duration-700 group-hover:scale-105" />
              </Link>
          </div>
        </div>
        <div className="lg:col-span-5 lg:order-1">
          ...
          <h2 className="display-md mt-8 text-cocoa">SHAARAV Garam Masala</h2>
