...
export const ProductsFromsampletoshipment = () => (
      ...
      <div className="container-x grid items-center gap-12 lg:grid-cols-12">
        <div className="lg:col-span-7 lg:order-2">
          <div className="relative">
            <div className="absolute -right-6 -top-6 hidden h-32 w-32 border border-primary/40 lg:block" />
              <img src={macroTurmeric} alt="From sample to shipment." className="relative h-[64vh] w-full object-cover shadow-deep" />
          </div>
        </div>
        <div className="lg:col-span-5 lg:order-1">
          <div className="flex items-center gap-4">
            ...
            <span className="text-xs uppercase tracking-[0.3em] text-cocoa/55">Buyer support</span>
          </div>
          <h2 className="display-md mt-8 text-cocoa">From sample to shipment.</h2>
          <p className="mt-6 text-lg leading-relaxed text-cocoa/75">Specifications, label files, sample dispatch, and a clear handoff into repeat production.</p>
